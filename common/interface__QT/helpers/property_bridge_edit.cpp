...
Q_Property_Bridge_Int::Q_Property_Bridge_Int(QWidget *p_parent,bool p_vertical) :  QVBoxLayout(p_parent) {
	...
	slider_hbox = new QHBoxLayout(this);
...
Q_Property_Bridge_Float::Q_Property_Bridge_Float(QWidget *p_parent, bool p_text_visible) :  QVBoxLayout(p_parent) {
...
Q_Property_Bridge_Float_Dial::Q_Property_Bridge_Float_Dial(QWidget *p_parent) :  QVBoxLayout(p_parent) {
...
Q_Property_Bridge_Int_CSpinButon::Q_Property_Bridge_Int_CSpinButon(QWidget *p_parent) :  QHBoxLayout(p_parent) {
...
Q_Property_Bridge_Bool::Q_Property_Bridge_Bool(QWidget *p_parent,bool p_vertical) : QVBoxLayout(p_parent) {
	...
	QHBoxLayout *auxhb = new QHBoxLayout(this);
...
Q_Property_Bridge_Options::Q_Property_Bridge_Options(QWidget *p_parent) :  QVBoxLayout(p_parent) {
...
Q_Property_Bridge_String::Q_Property_Bridge_String(QWidget *p_parent) :  QVBoxLayout(p_parent) {
...
Q_Property_Bridge_String_Multiline::Q_Property_Bridge_String_Multiline(QWidget *p_parent) :  QVBoxLayout(p_parent) {
