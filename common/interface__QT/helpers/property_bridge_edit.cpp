...
void Q_Property_Bridge_Int::set_bridge(Int_Property_Bridge *p_bridge) {
	...
	connection = bridge->changed_signal.connect(sigc::mem_fun(*this, &Q_Property_Bridge_Int::bridge_changed));
}
...
void Q_Property_Bridge_Float::set_bridge(Float_Property_Bridge *p_bridge) {
	...
	connection = bridge->changed_signal.connect(sigc::mem_fun(*this, &Q_Property_Bridge_Float::bridge_changed));
}
...
void Q_Property_Bridge_Float_Dial::set_bridge(Float_Property_Bridge *p_bridge) {
	...
	connection = bridge->changed_signal.connect(sigc::mem_fun(*this, &Q_Property_Bridge_Float_Dial::bridge_changed));
}
...
//	spin->setSizePolicy(QSizePolicy(QSizePolicy::Maximum,QSizePolicy::Maximum));
	...
	connection = bridge->changed_signal.connect(sigc::mem_fun(*this, &Q_Property_Bridge_Int_CSpinButon::bridge_changed));
}
...
void Q_Property_Bridge_Bool::set_bridge(Bool_Property_Bridge *p_bridge) {
	...
	connection = bridge->changed_signal.connect(sigc::mem_fun(*this, &Q_Property_Bridge_Bool::bridge_changed));
}
...
void Q_Property_Bridge_Options::set_bridge(Options_Property_Bridge *p_bridge) {
	...
	connection = bridge->changed_signal.connect(sigc::mem_fun(*this, &Q_Property_Bridge_Options::bridge_changed));
}
...
void Q_Property_Bridge_String::set_bridge(String_Property_Bridge *p_bridge) {
	...
	connection = bridge->changed_signal.connect(sigc::mem_fun(*this, &Q_Property_Bridge_String::bridge_changed));
}
...
void Q_Property_Bridge_String_Multiline::set_bridge(String_Property_Bridge *p_bridge) {
	...
	label->setText(bridge->get_name().c_str());
	text_edit->setText(p_bridge->get().c_str());
	connection = bridge->changed_signal.connect(sigc::mem_fun(*this, &Q_Property_Bridge_String_Multiline::bridge_changed));
}
