...
QHBoxLayout * Envelope_Editor::get_control_box() {
...
Envelope_Editor::Envelope_Editor(QWidget * p_parent) : QGroupBox ( 1, Qt::Vertical,"Envelope:",p_parent) {
	...
	envelope_point_editor_frame = new QHBoxLayout (vbox);
	...
	control_hbox = new QHBoxLayout(control_group);
	...
	table = new QGridLayout(4,control_loop);
