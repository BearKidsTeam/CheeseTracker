...
Sample_Editor_Effects::Sample_Editor_Effects(QWidget *p_parent) : QVBoxLayout(p_parent) {
	...
	useless_gb->setSizePolicy(QSizePolicy(QSizePolicy::Expanding,QSizePolicy::Expanding));
        QVBoxLayout * split_vbox = new QVBoxLayout(useless_gb);
	split_vbox->setSizePolicy(QSizePolicy(QSizePolicy::Expanding,QSizePolicy::Expanding));
        QHBoxLayout * split_hbox = new QHBoxLayout(split_vbox);
	...
	/* apply button */
	QHBoxLayout * auxhv = new QHBoxLayout(split_vbox);
