...
Mixer_Effects_Manager::Mixer_Effects_Manager(QWidget *p_parent) : QHBoxLayout(p_parent) {

	QVBoxLayout * buffer_splitter = new QVBoxLayout(this);
	...
	QVBoxLayout * route_splitter = new QVBoxLayout(this);
	...
	QVBoxLayout * output_splitter = new QVBoxLayout(send_gb);
	QHBoxLayout *output_buffer_splitter = new QHBoxLayout(output_splitter);
	...
	QHBoxLayout *output_send_splitter = new QHBoxLayout(output_splitter);
