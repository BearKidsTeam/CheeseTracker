...
Sample_Editor::Sample_Editor(QWidget *p_parent) : QVBoxLayout(p_parent)   {
	...
	format_box = new QHBoxLayout(this);
	...
	QVBoxLayout *auxvb2 = new QVBoxLayout(tabs);
	auxvb2->setMargin(5);
	...
	QVBoxLayout *auxvb2_2 = new QVBoxLayout(tabs);
