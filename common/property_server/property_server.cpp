...
PropertyServerSlave::PropertyServerSlave() {
	...
	client->deliver_event.connect(sigc::mem_fun(*this,&PropertyServerSlave::got_message_signal));
};
...
PropertyServerMaster::PropertyServerMaster() {
	...
	server->deliver_event.connect(sigc::mem_fun(*this,&PropertyServerMaster::got_message_signal));
};
