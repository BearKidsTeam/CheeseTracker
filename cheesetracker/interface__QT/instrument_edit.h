...
class Instrument_Edit : public QHBoxLayout {
	...
	public:
			...
			ListviewItem( QTreeWidget * p_parent ) :  QTreeWidgetItem(p_parent) {}
...
protected Q_SLOTS:
	...
	void item_selected_cbk(QTreeWidgetItem *p_item);
	void item_renamed_cbk(QTreeWidgetItem *item, int col );
