...
Order_And_Defaults_Editor::Defaults::Entry::Entry(QWidget *p_parent) : QHBoxLayout(p_parent) {
...
Order_And_Defaults_Editor::Order_And_Defaults_Editor(QWidget *p_parent) : QHBoxLayout(p_parent) {
...
//	defaults.scroll = new Vertical_Scrolled_Window(this);
	...
	defaults.scrolled_box = new QVBoxLayout(defaults.scroll->viewport());
