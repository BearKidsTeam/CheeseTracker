...
Pattern_Edit_Widget::Pattern_Edit_Widget(QWidget *p_parent) : QVBoxLayout(p_parent) {

	editing_options=new QHBoxLayout(this);
	...
	editing_options_instrument=new QHBoxLayout(this);
	...
	aux_frame = new QHBoxLayout(this);
	aux_frame->setFrameStyle(Panel+Sunken);
	aux_frame->setSizePolicy(QSizePolicy(QSizePolicy::Expanding,QSizePolicy::Expanding));



	QGridLayout *grid = new QGridLayout(2,aux_frame);
